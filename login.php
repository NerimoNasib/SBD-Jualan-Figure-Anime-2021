...
<head>
    ...
    <style>
        ...
        .wrapper{ 
            ...
            background-color: rgb(191, 77, 46);
            opacity:0.9;
...
<body>
    <div class="wrapper">
        <h1><b>Jual Figur Kancolle Ega</b><h1>
        <h2><b>Login</b></h2>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p><b>Ingin Mendaftar?</b> <a id="hrefHalamanLogin" href="register.php">Daftar sekarang</a>.</p>
            <p>Login Sebagai Admin: <a id="hrefHalamanLogin" href="loginadmin.php">Klik disini</a>.</p>
        </form>
    </div>
</body>
</html>