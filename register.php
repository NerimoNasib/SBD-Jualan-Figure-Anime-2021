...
<head>
    ...
    <style>
        body{ 
            ...
            background-image: url('https://mahoutofu.files.wordpress.com/2015/02/kancolle_05-4.png');
            height: 100%; 
        ...
        .wrapper{ 
            ...
            border-style: groove;
            border-width: 10px;
            border-color: rgb(209, 98, 29);
            background-color: rgb(209, 176, 128);
            opacity:0.9;
...
<body>
    <div class="wrapper">
        ...
        <h3><p>Isi form di bawah ini!</p></h3>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Sudah punya akun? <a id="hrefLogin" href="login.php">Kembali ke Halaman Login</a>.</p>
        </form>
    </div>    
</body>
</html>